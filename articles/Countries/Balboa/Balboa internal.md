...
| Province | Capital | Area (km²) | Pop (2026) |
|----------|---------|-------------|------------|
| Tramuntana | Portblanc | 111,848 | 1,900,000 |
...
- **Nurra** = from Birú Dale *nurra* (sea) — Volisanian corruption of the Birú word for the sea; applied to the Aethiopean coastal province
- **Jala** = from Birú Dale *yala* (land/territory/mountain) — Volisanian corruption of the Birú word for land; applied to the central highlands, the heartland of the isthmus
- **Estret** = "the narrow/strait" (Catalan) — the narrow isthmus crossing where the canal is
...
**Areza**: International enclave within Estret Province. NOT part of Balboa — permanently neutral, governed under Treaty of Areza (1973). Seat of AC Assembly. Technically and legally not Balboan territory.

NOTE: Province populations are estimates that need verification.
...
|------|------|----------|------------|-------|
| 1 | Sant Cristòfor | Estret | 5,200,000 | Capital; Aethiopean coast; largest city |
...
### Economic history
1. Colonial era: plantation economy (sugar, coffee, bananas); enslaved Birú then enslaved Kaftians; export to Volisania; no industrial development
2. Independence/rump state: remained agricultural; white planter oligarchy; Redilution/Birthing expanded white workforce but didn't change structure; canal built 1885 but revenue went to Volisania/Zong
3. Zong Balboa (1899–1950): Fosian immigration + infrastructure in canal corridor; benefits concentrated in Zong zone; rump interior excluded
4. AC mandate (1950–1960): reconstruction of Sant Cristòfor + canal; mandate economy separate from rump state
5. Reunification (1973+): integration of canal zone; land redistribution + reparations; transition to services economy; BPP investment in education, infrastructure, logistics, financial services; cooperative farms as rural safety net

### Canal & trade
- ~14,000 transits/year; ~$6.5B toll revenue (2026)
- AC Canal Commission: international oversight, non-discriminatory access
- Sant Cristòfor harbour: busiest port on isthmus; container transshipment, bulk cargo, petroleum
- Sant Cristòfor Free Trade Zone (est. 1978): largest in Lurandia; re-export centre (Illypnia ↔ Fosia ↔ Kaftia)
- Balboan Ship Registry (est. 1982): flag of convenience; low fees, minimal tax, flexible crewing; significant revenue; criticised for substandard working conditions
...
### Services
- Sant Cristòfor = major financial hub for Lurandia (preeminent in the region)
- Position at junction of Illypnian, Fosian, Kaftian markets
...
- **Corporació Petrolífera de l'Estat de Balboa (CPEB)**: state-owned petroleum company; manages offshore oil extraction in deepwater Shendan Sea, in deep waters off the Tramuntana coast near the outer limit of Balboa's EEZ; est. 1984; ~185,000 bbl/day; mostly for domestic consumption; crude processed at CIEA's Badia Curta refinery under supply agreements; 100% government-owned; HQ Sant Cristòfor; 2,800 employees; revenue $3.4B; NOT listed (state-owned); **Article**: `articles/Countries/Balboa/Economy/Corporació Petrolífera de l'Estat de Balboa.mediawiki`
...
## Religion
Religiously pluralistic (no majority denomination):
- Catholicism: ~40% (largest; white, mixed, many Black; Archdiocese of Sant Bart)
- Tianism: ~25% (Fosian community; majority of Fosian + growing converts; temples in cities)
- No religion: ~20% (growing since reunification; urban professionals, younger generations)
- Protestantism: ~10% (modest; urban communities; evangelical/Pentecostal growing slowly)
- Indigenous/syncretic: ~5% (rural interior; Birú; blends Catholic, Tianist, Birú elements)
...
## Transport — expanded 2026-05-17

### Roads
- ~12,000 km paved highways/major roads
- 6 national expressways (odd = N–S, even = E–W):
...
- Intercon: regional rail operator for Estret province; commuter + intercity from Sant Cristòfor
  - HSR: Sant Cristòfor ↔ Areza; Sant Cristòfor ↔ Portnou
...
## Culture
- **istmo son** — musical genre from Sant Cristòfor mandate period; blends Volisanian, Kaftian, Fosian traditions
- **Hip hop** — originated in Balboa from the disc jockey movement of the 1970s (merger period); especially Sant Bart; Black Balboan DJs developed turntable techniques and block-party culture; influenced musical traditions worldwide

## International Relations
- AC member state; host of AC Assembly (Areza)
- Generally neutral on world stage
- Biggest trading partners: Louyang, Balisca, Tapuya, Sinchew
- Cordial relations with Zong (Fosian community links, Zong Balboa legacy)
- Complicated relations with Volisania (former colonizer, GAW alliance, Mendez legacy)
- Twelve Guarantees still in force; ICPF still operates but mandate progressively reduced since 1990s

## Pre-colonial & Colonial History (added 2026-05-17)

### Pre-colonial (Birú chiefdoms)
- **Sahilato** = Birú chiefdom (from Birú Dale *sahila* = village leader)
- **Sahila** = chief of a sahilato
- Fragmented network of chiefdoms across the isthmus
...
- Matrilineal society; descent/inheritance through female line; sahilas typically men but determined by senior women of ruling lineage

### Colonial period
- Volisanian contact: early 16th century
- Conquest: violent, over several decades; superior weaponry + exploitation of rivalries + disease
- Birú population: 500K–1M at contact → fewer than 50K within a century
- Colonial administration established 1530s
- Encomienda system: Birú displaced from fertile lands, forced labour in mines/plantations
- Birú who escaped retreated to remote highlands (ancestors of today's 3%)
- Trans-Kaftian slave trade replaced Birú labour
- By 18th century: enslaved/free Black population vastly outnumbered Volisanian settlers and Birú remnant
- Sant Cristòfor: free port on Aethiopean coast, developed outside plantation system
- Slavery abolished 1848 (second-to-last Volisanian colony)
- Post-abolition: debt peonage and contract labour maintained planter oligarchy

### Post-independence demographic engineering (1854–1890)
- **Redilution** = planter-class movement to "dilute" the Black majority through Illypnian immigration
- **Birthing movement** = parallel programme promoting Illypnian family settlement and high birth rates via financial incentives, propaganda, preferential land access
- Government subsidised passage, land grants, start-up capital for Illypnian settlers (Volisania, Breisland, northern Mesogean states)
- White proportion rose from ~15% to over 30% between 1854 and 1890
- Black proportion declined correspondingly
- Widely condemned by Black Balboan leaders as deliberate dispossession
- Central grievance in post-reunification reparations debates

### Invented terms
- **Sahilato** = Birú chiefdom (from Birú Dale *sahila*)
- **Sahila** = chief (from Birú Dale *sahila*)
- **Encomienda** = Volisanian estate system (borrowed from real-world Spanish colonial term)
- **AC Assembly** (NOT "AC Parliament") — user corrected 2026-05-17. Update all references across articles.

## Open Questions
- Population figures for provinces and special districts — need real numbers
- Tramuntana and Llevant province capitals — need names
- More detail on current president Lim Hui-jin (bio, party, when elected)
- More detail on vice president Adalberto Paredes
- GDP figures — are these reasonable for upper-middle income with canal?
- Military: more detail on BDF (navy, air force components)
- Transport infrastructure detail
- Energy infrastructure detail
- Culture section needs expansion
- Image placeholders to add
- Administrative divisions article (separate from main country article?)

## Files
- `articles/Countries/Balboa/Balboa.mediawiki` — main country article
- `articles/Countries/Balboa/Balboa internal.md` — this file
- `articles/Countries/Balboa/History/Republic of Balboa (1899–1973).mediawiki` — rump state article
- `articles/Countries/Balboa/History/Republic of Balboa (1899–1973) internal.md` — rump state internal notes
