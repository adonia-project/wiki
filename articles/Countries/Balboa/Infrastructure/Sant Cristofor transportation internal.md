...
Since 2022, the Metro de Sant Cristòfor has been constructing **Line 10**, a fully automated (driverless) north-south line running from the centre of Barcelona through to Dàrsena. The line would provide a more direct north-south connection between the peninsula and the eastern mainland, supplementing the overland routes of Lines 5 and 6 which run around the bay shore. As a fully automated system, Line 10 is expected to operate at higher frequency and lower operating cost than conventional metro lines. The project has faced delays due to the complexity of tunneling under the bay mouth and the need to coordinate with the existing streetcar infrastructure in Barcelona's centre. No opening date has been announced.
